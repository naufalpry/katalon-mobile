Feature: Open Default App
  ...
  Scenario: Open SwagLabs App to login App
   ...
   Scenario: Pick One Product using contains xpath
    And I should see 'Items/android.view.ViewGroup - View product vertical'
    And I click 'Items/android.view.ViewGroup - View product vertical'
    And I wait for 1 seconds
    Then I should see 'Items/android.view.ViewGroup - Item contains'
    Then I wait for 1 seconds
