$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/feeder_aginta/Documents/SauceDemo/Sauce-Demo-Android/Include/features/Homepage Swaglabs/Login-SwagLabs.feature");
formatter.feature({
...
formatter.step({
  "name": "I should see \u0027Login/android.widget.ViewGroup - LoginBtn\u0027",
  "keyword": "And "
});
formatter.match({
  "location": "MystepDefinition.I_should_see(String)"
