$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/feeder_aginta/Documents/SauceDemo/Sauce-Demo-Android/Include/features/Homepage Swaglabs/See pick one product using contains xpath.feature");
formatter.feature({
...
formatter.step({
  "name": "I should see \u0027Items/android.view.ViewGroup - Item contains\u0027",
  "keyword": "Then "
});
formatter.match({
  "location": "MystepDefinition.I_should_see(String)"
...
formatter.step({
  "name": "I click \u0027android.view.ViewGroup - Item contains\u0027",
  "keyword": "Then "
});
formatter.match({
  "location": "MystepDefinition.I_click(String)"
