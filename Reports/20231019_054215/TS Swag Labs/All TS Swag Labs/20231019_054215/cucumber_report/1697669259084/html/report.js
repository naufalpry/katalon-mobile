$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/feeder_aginta/Documents/SauceDemo/Sauce-Demo-Android/Include/features/Homepage Swaglabs/See pick one product using following sibling xpath.feature");
formatter.feature({
...
formatter.scenario({
  "name": "Pick one Product using following sibling xpath",
  "description": "",
  "keyword": "Scenario"
});
formatter.step({
...
formatter.step({
  "name": "I should see \u0027android.view.ViewGroup - Item following sibling\u0027",
  "keyword": "Then "
});
formatter.match({
  "location": "MystepDefinition.I_should_see(String)"
...
formatter.step({
  "name": "I click \u0027android.view.ViewGroup - Item following sibling\u0027",
  "keyword": "Then "
});
formatter.match({
  "location": "MystepDefinition.I_click(String)"
